...
public class PublicMemberController {
    ...
    public String showMemberForm(Model model){
        ...
        setModelAttributesForMemberForm(model);
    ...
    private void setModelAttributesForMemberForm(Model model) {
        ...
        model.addAttribute("pageTitle", "Members Form");
    }
    ...
    public String memberFormSubmitted(Model model){
        ...
        model.addAttribute("churchDetail", churchDetailService.getChurchDetail());
        model.addAttribute("pageTitle", "Member Form Submitted");
